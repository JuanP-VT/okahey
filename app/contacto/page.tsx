        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          <div className="space-y-4 rounded-md bg-zinc-200 p-4">
            ...
            <p className="max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Nos encontramos a las afueras de la ciudad de Los Mochis, lejos de
              las distracciones de la ciudad.
            </p>
            <div className="grid gap-2">
              ...
              <div className="mt-2 font-medium">Contacto:</div>
              <Link
              ...
              <div>Email: coyotlbri@gmail.com</div>
            </div>
          </div>
        </div>
        <div className="mt-12 space-y-4 rounded-md bg-slate-200 p-4">
          <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">
            Cómo llegar
          </h2>
          <p className="max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Tomamos el Boulevard General Macario Gaxiola, en dirección a la
            ...
            <div className="grid gap-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                El nombre del local es la Huerta
              </p>
            </div>
          </div>
        </div>
